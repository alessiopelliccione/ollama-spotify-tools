...
def generate_updated_readme(current_content, git_diff, commit_log):
    ...
    """
    prompt = f"""You are an expert technical writer maintaining documentation for a TypeScript-based toolkit for Ollama and Spotify Web API called 'ollama-spotify-tools'.
...
- Features section (new capabilities for Ollama/Spotify interaction)
