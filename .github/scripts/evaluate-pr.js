module.exports = async ({ github, context, core }) => {
    ...
    const systemPrompt = `
You are a Senior TypeScript Engineer working on "Ollama Spotify Tools", a toolkit for connecting Ollama to the Spotify Web API.
...
3. Check for efficient use of Spotify Web API and Ollama client integrations.
4. Evaluate adherence to project conventions and architectural patterns.
5. Look for potential performance bottlenecks in Node.js asynchronous operations.
6. Be very concise. Focus on key architectural insights and high-impact suggestions. Use bullet points.
7. If the code looks good, give brief compliments but still look for areas of improvement.
...
`;
    ...
    const commentBody = `
## 🤖 Ollama Spotify Tools AI Code Review
...
`;
    ...
    const botComment = comments.data.find(c => c.body.includes('## 🤖 Oxy AI Code Review'));
